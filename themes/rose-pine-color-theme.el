;;; rose-pine-color-theme.el --- Rosé Pine theme -*- lexical-binding: t -*-

;;; rose-pine-color-theme.el --- All natural pine, faux fur and a bit of soho vibes for the classy minimalist.
