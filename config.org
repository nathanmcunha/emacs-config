...
** Python Development (Eglot + Pyright + Ruff)
This configuration ensures that Eglot communicates with Pyright using strict type checking while pet.el handles your virtual environments and Ruff handles your linting.
...
#+begin_src emacs-lisp
    (with-eval-after-load 'project
      ...
      :hook (((python-mode python-ts-mode) . eglot-ensure)
             ((js-ts-mode js-mode javascript-mode) . eglot-ensure)
             ((typescript-ts-mode typescript-mode tsx-ts-mode) . eglot-ensure)
             ((html-ts-mode html-mode) . eglot-ensure)
             ((css-ts-mode css-mode) . eglot-ensure)
             ((dockerfile-ts-mode dockerfile-mode) . eglot-ensure)
      ...
      ;; npm install -g dockerfile-language-server-nodejs yaml-language-server typescript-language-server typescript vscode-langservers-extracted
      ...
      ;; 3. HTML: vscode-html-language-server (from vscode-langservers-extracted)
      (add-to-list 'eglot-server-programs
                   '((html-ts-mode html-mode) . ("vscode-html-language-server" "--stdio")))

      ;; 4. CSS: vscode-css-language-server (from vscode-langservers-extracted)
      (add-to-list 'eglot-server-programs
