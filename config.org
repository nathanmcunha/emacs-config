...
#+begin_src emacs-lisp
    ...
    :after evil
    :demand t ;; Force load immediately after evil
    :custom
    ;; Magit Integration Settings
    ...
    :config
    ;; Initialize bindings for all supported modes (including magit)
...
#+begin_src emacs-lisp
  ...
  (:states '(normal visual)
   ...
   "<tab>" 'magit-section-toggle)
  :config
    ;; 1. Ensure evil-collection setup runs for magit buffers
    (with-eval-after-load 'evil-collection
      (evil-collection-init 'magit))

    ;; 2. Optional: Manual fallback if evil-collection fails
    ;; Force Magit buffers to start in Normal state (Vim mode)
