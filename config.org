...
#+begin_src emacs-lisp
  ...
  (use-package evil-exchange
    :ensure t
    :commands (evil-exchange evil-exchange-install)
    :config
...
#+begin_src emacs-lisp
  (use-package nerd-icons
    ...
    (add-to-list 'nerd-icons-extension-icon-alist '("gradle" my-nerd-icons-faicon-small "nf-fa-cog"))
    (add-to-list 'nerd-icons-extension-icon-alist '("kts" my-nerd-icons-faicon-small "nf-fa-cog"))
  ...
  (use-package doom-modeline
    ...
    (setq doom-modeline-position-line-format '("%l")) ;; Show only line number (no "L" prefix)
...
#+begin_src emacs-lisp
  (use-package consult
    ...
    (my-leader-def
      ...
      "f d" '(consult-dir :which-key "find directory")
...
#+begin_src emacs-lisp
  (use-package corfu
    :custom
    (corfu-auto nil)                 ;; Disable auto completion (LAG FIX)
