...
#+begin_src emacs-lisp
  (use-package general
    ...
    (my-leader-def
      ...
      "f R" '((lambda () (interactive) (load-file user-init-file)) :which-key "reload config")))
...
#+begin_src emacs-lisp
  (use-package consult
    ...
    (my-leader-def
      ...
      "g e" '(consult-flymake :which-key "goto error (flymake)")))
...
#+begin_src emacs-lisp
  (defun my/launch-alacritty (dir) "Launch Alacritty in DIR." (let ((proc (start-process "alacritty" nil "alacritty" "--working-directory" dir))) (set-process-query-on-exit-flag proc nil)))
