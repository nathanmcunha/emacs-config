...
#+begin_src emacs-lisp
        ...
        (use-package evil-collection
          ...
          (evil-collection-magit-use-z-for-folds t)       ;; Use 'z' to fold sections
...
(use-package projectile
  ...
  (my-leader-def
    ...
    "p f" '((lambda () (interactive) (consult-find (projectile-project-root))) 
            :which-key "find file (project)")
...
#+BEGIN_SRC emacs-lisp
  (my-leader-def
    ...
    ;; Time Machine (Opcional, se usar git-timemachine)
