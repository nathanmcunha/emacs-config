...
#+begin_src emacs-lisp
  (use-package apheleia
    ...
    :config
     ...
     ;; Define Ruff as the primary formatter for Python
...
#+begin_src emacs-lisp
    (with-eval-after-load 'project
      ...
      ;; Add Ruff LSP support using the built-in 'ruff server'
      (add-to-list 'eglot-server-programs
      ...
      '(:python (:analysis (:typeCheckingMode "basic" ; Changed from strict to basic
      :autoSearchPaths t
      ...
      (lambda ()
      (setq-local python-shell-interpreter (or (pet-executable-find "python") "python3")
      python-shell-virtualenv-root (pet-virtualenv-root))

                ;; Ensure pet-eglot-setup runs to inject venv paths into Eglot
                (pet-eglot-setup))))
