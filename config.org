...
#+begin_src emacs-lisp
  (use-package apheleia
    ...
    :config
     ...
     (push '(python-ts-mode . black) apheleia-mode-alist)) #+end_src
...
** Python Development (Eglot + Pyright)
...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    ;; Keybindings for Eglot Python
    (define-key python-mode-map (kbd "C-c C-r") 'eglot-rename)
    (define-key python-mode-map (kbd "C-c C-f") 'eglot-format)
    (define-key python-mode-map (kbd "C-c C-a") 'eglot-code-action-quickfix)
    (define-key python-mode-map (kbd "C-c C-d") 'eglot-show-doc))
  ...
  ;; Python-specific project commands
  (defun my/python-project-test ()
  ...
  (defun my/python-project-format ()
    "Format Python files in the project using Black."
    (interactive)
    (let ((project (project-current)))
      (if project
          (let ((default-directory (project-root project)))
...
#+begin_src emacs-lisp
  ...
  (use-package agent-shell
    ...
    :config
    ;; Use eat as terminal backend (matches your setup)
